@extends('master')
@section('title','Send Delivery Order')
@section('link','Send Delivery Order')
@section('content')
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Send Delivery Order</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">

            	<form method="post" action="{{route('store_delivery_order')}}">
            		@csrf
		            ...
		            <input type="submit" name="btnsubmit" class="btn btn-primary float-right" value="Send Delivery Order">
		        </form>
