...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <h1 class="text-center font-weight-bold font-italic text-info ml-auto">Inventory Management</h1>
    <!-- Right navbar links -->
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="{{asset('image/logo.jpg')}}" alt="K-win Technology" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">K-win Technology</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav sidebar-nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{route('material_issue')}}" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
                Material Issue
              </p>
          ...
          <li class="nav-item">
            <a href="{{route('good_receive_form')}}" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
                Good Receive Note
              </p>
